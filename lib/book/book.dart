...
final List<Book> books = [
  ...
  Book(
    ...
    author: 'Adam Brown',
    description:
        'Description: Dark Psychology: Learn to Influence Anyone Using Mind Control, Manipulation, and Deception explores the often unsettling techniques of psychological manipulation and persuasion. This book delves into the darker aspects of human behavior, revealing methods used to influence others covertly and effectively. It covers various strategies, including mind control, deception, and emotional manipulation, providing readers with insights into how these tactics operate in everyday life. By examining concepts such as hypnotism, brainwashing, and mind games, the book aims to equip readers with knowledge about both the mechanics of influence and the ethical implications of using such techniques. Through practical examples and case studies, it encourages critical thinking about the power dynamics in interpersonal relationships and highlights the importance of self-awareness in protecting oneself from manipulation. Ultimately, this work serves as a cautionary guide, urging readers to navigate the complex landscape of human interactions with discernment and ethical consideration.',
    imageUrl: 'asset/dark.jpeg',
    downloadUrl: 'https://play.google.com/store/books/details/Adam_Brown_Dark_Psychology?id=rmhoDwAAQBAJ&hl=en', // Add download link
  ),
];
